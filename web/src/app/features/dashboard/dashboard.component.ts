...
import { FormatColumnPipe, IsWideColumnPipe, FormatCurrencyPipe, FormatBytesPipe } from './dashboard.pipes';
...
@Component({
  ...
  imports: [FormsModule, FormatColumnPipe, IsWideColumnPipe, FormatCurrencyPipe, FormatBytesPipe],
